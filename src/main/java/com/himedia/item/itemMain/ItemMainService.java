...
public class ItemMainService {
	...
	//카테고리 정렬 
	public Page<Item> findItemsByCategory(CategoryEnum categoryEnum, CategoryEnum2 categoryEnum2, int page) {
		
		int size = 9;
		Pageable pageable= PageRequest.of(page-1, size);
		
		return itemMainRepository.findByCategoryEnumOrCategoryEnum2(categoryEnum, categoryEnum2, pageable);
	}
